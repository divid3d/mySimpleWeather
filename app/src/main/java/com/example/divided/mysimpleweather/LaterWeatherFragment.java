...
public class LaterWeatherFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((MainActivity) Objects.requireNonNull(getActivity())).setActivityListenerFragmentTwo(new ListenFromActivity() {
            @Override
            public void getWeatherByCity(String cityName, String date, boolean today) {
                myApiManager.getHourWeather(date, cityName, false);
            }

            @Override
            public void getWeatherByCordinates(double longitude, double latitude, String date, boolean today) {
                myApiManager.getHourWeather(date, latitude, longitude, false);
            }
        });
        return rootView;
    }
